...
<body>
  ...
  ?>
    ...
    <section class="main-page">
        <img class="backgroung-img-login" src="./images/undraw_forms_re_pkrt.svg" alt="">
        ...
        <div class="form-div">
            <form action="../controller/RegistrationAction.php" method="post" novalidate>
                ...
                <input class="input-field" type="text" id="fname" name="fname"> <?php echo $_SESSION['firstNameErr'] ?>

                <p class="label lname">Last Name<span class="required">*</span></p>
                <input class="input-field" type="text" id="lname" name="lname"> <?php echo $_SESSION['lastNameErr'] ?>
                ...
                <input class="input-field" type="email" id="email" name="email"> <?php echo $_SESSION['emailErr'] ?>

                <p class="label pass">Password<span class="required">*</span> (4 characters minimum)</p>
                <input class="input-field" type="password" id="pass" name="pass"> <?php echo $_SESSION['passErr'] ?>
                <p class="label cpass">Confirm Password<span class="required">*</span></p>
                <input class="input-field" type="password" id="cpass" name="cpass">
